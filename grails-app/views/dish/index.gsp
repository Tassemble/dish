		...
		<div id="list-dish" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="pictureUrl" title="${message(code: 'dish.pictureUrl.label', default: 'Picture Url')}" />
					
						<th><g:message code="dish.restaurant.label" default="Restaurant" /></th>
