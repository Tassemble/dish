		...
		<div id="list-image" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="imageFile" title="${message(code: 'image.imageFile.label', default: 'Image File')}" />
				...
				<g:each in="${imageInstanceList}" status="i" var="imageInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${imageInstance.id}">${fieldValue(bean: imageInstance, field: "imageFile")}</g:link></td>
